...

{
...

    {
        ...
        // 1 = Either Player 1 or 2 has won
        // -1 = Draw
        // 0 = match is currently running
...

        {
...

            {
                ...
                choice = int.Parse(Console.ReadLine());// reading the player's choice 



                // checking player's position marked with 'X" or 'O'
                ...
                else // prevent a player from taking a occupied space 

                {
                    ...
                    Console.WriteLine("Please wait 2 seconds for board to reload . . .");
            ...
            else// flag value is -1 the match is a draw
        ...
        // methods that checj which player has won
